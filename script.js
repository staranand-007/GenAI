...
// API Setup
const API_KEY = "AQ.Ab8RN6JkaH8hmM7vBi-zmvVeSRD8c8Eu_va7ZdGQh9hDJVbHHQ";
...
const generateBotResponse = async (incomingMessageDiv) => {
    ...
    try {
        ...
        // Extracting and displaying the bot's message
...
const handleOutgoingMessage = (e) => {
    ...
    // Stimulating bot response with thinking indicator after a delay
    setTimeout(() => {
...
// Adjusting input field dynamically
...
// Handling file input changes and previewing the selected file
